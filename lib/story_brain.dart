...
//TODO: Step 22 - In nextStory() if the storyNumber is equal to 3 or 4 or 5, that means it's the end of the game and it should call a method called restart() that resets the storyNumber to 0.
  ...
  void report() {
    print('storyNumber is $_storyNumber');
  }


  void nextStory(int choiceNumber) {
    if (_storyNumber == 0 && choiceNumber == 1) {
      print('$_storyNumber is the var for _storyNumber');
      _storyNumber = 2;
      print('$_storyNumber may have changed');
...
//TODO: Step 27 - Create a method called buttonShouldBeVisible() which checks to see if storyNumber is 0 or 1 or 2 (when both buttons should show choices) and return true if that is the case, else it should return false.
  bool buttonShouldBeVisible() {
    List<int> showOption = <int>[0,1,2];
    if (showOption.contains(_storyNumber)) {
      return true;
    }
    else {
      return false;
